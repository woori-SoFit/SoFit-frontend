...
export const STATUS_BADGE: Record<LoanApplicationStatus, StatusBadgeInfo> = {
  ...
  CB_CHECKING: { label: "심사 중", color: "bg-blue-100 text-primary" },
  BASIC_REVIEW: { label: "심사 중", color: "bg-blue-100 text-primary" },
  S_CALCULATING: { label: "심사 중", color: "bg-blue-100 text-primary" },
  S_COMPLETED: { label: "심사 중", color: "bg-blue-100 text-primary" },
  SYSTEM_APPROVED: { label: "심사 중", color: "bg-blue-100 text-primary" },
  SYSTEM_REJECTED: { label: "심사 중", color: "bg-blue-100 text-primary" },
  MANAGER_REVIEW: { label: "심사 중", color: "bg-blue-100 text-primary" },
  FINAL_REVIEW: { label: "심사 중", color: "bg-blue-100 text-primary" },
